...
12. **Realtime Voice**:
Build [speech-to-speech agents](https://ai.pydantic.dev/api/realtime) on native realtime models over a persistent bidirectional audio connection, with the same tools, capabilities, and observability as any other agent.
