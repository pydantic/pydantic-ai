...
from pydantic_graph.graph_builder.id_types import ForkID, ForkStack, ForkStackItem, JoinID, NodeID, NodeRunID, TaskID
from pydantic_graph.graph_builder.join import Join, JoinNode, JoinState, ReducerContext
from pydantic_graph.graph_builder.node import (
    EndNode,
    Fork,
    StartNode,
)
from pydantic_graph.graph_builder.node_types import AnyNode
from pydantic_graph.graph_builder.parent_forks import ParentFork
...
from pydantic_graph.graph_builder.step import NodeStep, Step, StepContext, StepNode
from pydantic_graph.graph_builder.util import unpack_type_expression
...
if TYPE_CHECKING:
    from pydantic_graph.graph_builder.mermaid import StateDiagramDirection
...
class Graph(Generic[StateT, DepsT, InputT, OutputT]):
    ...
    def render(self, *, title: str | None = None, direction: StateDiagramDirection | None = None) -> str:
        ...
        """
        from pydantic_graph.graph_builder.mermaid import build_mermaid_graph
