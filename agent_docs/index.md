...
- **[Docs atlas](docs-atlas.md)**: Generated map of published docs (pages, tokens, hubs, dispatch thresholds). Do not hand-edit; regenerate with `make docs-map`. Read it when exploring docs or deciding subagent dispatch.
<!-- /braindump -->
