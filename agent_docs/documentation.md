...
<!-- rule:107 -->
- Register new `docs/` files in both `mkdocs.yml` and `docs/navigation.yml` — Keeps the repository's MkDocs validation build and the published pydantic.dev/docs/ai navigation complete until the legacy MkDocs build is retired
<!-- rule:31 -->
