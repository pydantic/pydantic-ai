...
class PromptedOutputSchema(StructuredTextOutputSchema[OutputDataT]):
    ...
    @classmethod
    def create_instructions(cls, template: str, object_def: OutputObjectDefinition) -> str:
        """Create instructions from a template and an object definition."""
    ...
    def instructions(self, default_template: str) -> str:
        ...
        return self.create_instructions(template, object_def)
