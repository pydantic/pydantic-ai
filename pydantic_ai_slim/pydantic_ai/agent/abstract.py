...
class AbstractAgent(Generic[AgentDepsT, OutputDataT], ABC):
    ...
    def run_sync(
        ...
        *,
        ...
        This method cannot be called from a synchronous callback run by Pydantic AI, because attempting to run a
        second event loop there can deadlock. To delegate to another agent, make the callback `async def` and
    ...
    def run_stream_sync(
        ...
        *,
        ...
        synchronous callback run by Pydantic AI. See
        [Agent delegation](../multi-agent-applications.md#agent-delegation).
