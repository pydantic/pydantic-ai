...
class SandboxRef:
    ...
    A capability's [`resolve_sandbox`][pydantic_ai.capabilities.AbstractCapability.resolve_sandbox] turns it
    ...
    The framework stamps this field and uses it to route `resolve_sandbox` and `release_sandbox`
