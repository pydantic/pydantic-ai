...
class ConcurrencyLimit:
    ...
    def __post_init__(self) -> None:
        if self.max_running < 1:
            raise ValueError(f'max_running must be a positive integer, got {self.max_running}')
...
class ConcurrencyLimiter(AbstractConcurrencyLimiter):
    ...
    def __init__(
        ...
        *,
        ...
        """
        if max_running < 1:
            raise ValueError(f'max_running must be a positive integer, got {max_running}')
