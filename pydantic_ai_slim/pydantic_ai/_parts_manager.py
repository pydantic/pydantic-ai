    ...
    def handle_thinking_delta(
        ...
        *,
        ...
        Args:
            ...
            provider_details: Optional provider-specific details to attach to the thinking part.
                Can be a dict or a callable that receives the existing part's details.
