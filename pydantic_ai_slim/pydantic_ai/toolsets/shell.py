...
class ShellToolset(AbstractToolset[AgentDepsT]):
    ...
    """The shell executor. Use `ShellToolset.local` for a subprocess-based executor."""
    ...
    """Timeout in seconds per command. Raises `pydantic_ai.exceptions.ModelRetry` on timeout."""
