    ...
    def tool(
        ...
        *,
        ...
        def tool_decorator(
            ...
            func_name = name or getattr(func_, '__name__', repr(func_))
            if not self.tools[func_name].takes_ctx:
                warnings.warn(
                    'Passing a plain function to `FunctionToolset.tool` is deprecated, '
