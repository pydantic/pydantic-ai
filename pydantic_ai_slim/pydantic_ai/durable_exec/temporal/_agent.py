...
from pydantic_ai._tool_manager import skip_args_validator_func
...
class TemporalAgent(WrapperAgent[AgentDepsT, OutputDataT]):
    ...
    def _temporal_overrides(
        ...
        with (
            ...
            skip_args_validator_token = skip_args_validator_func.set(True)
            try:
                yield
                ...
                skip_args_validator_func.reset(skip_args_validator_token)
