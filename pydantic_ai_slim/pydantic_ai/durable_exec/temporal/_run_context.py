...
def deserialize_run_context(
    ...
    *,
    ...
    # Most activity results cannot carry queued messages back to the workflow. Tool-call handlers
    # replace this guard with a capture queue and include its messages in their recorded result.
