...
class TemporalRunContext(RunContext[AgentDepsT]):
    ...
    def __init__(self, deps: AgentDepsT, **kwargs: Any):
        kwargs.setdefault('workspace', Workspace(UnavailableWorkspace(TEMPORAL_WORKSPACE_UNAVAILABLE_REASON)))
