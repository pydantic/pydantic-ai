...
`CapabilityOperationId`, and `SandboxOperationId`. Capability methods marked with
`@durable_operation` and sandbox methods both arrive through the same backend and config resolver
