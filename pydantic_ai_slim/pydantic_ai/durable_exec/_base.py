    ...
    async def _invoke_capability_operation(
        ...
        *,
        ...
        if not applied.has_values():
            ...
            # recorded is missing from the span of the run that produced it; crediting `applied`
            # whole would count a nested or concurrent run's usage twice, once through its own
            # records and once here.
