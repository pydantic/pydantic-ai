...
# Context variable to track when we're inside our own Prefect flow
_in_prefect_agent_flow: ContextVar[bool] = ContextVar('_in_prefect_agent_flow', default=False)
