...
- **Workspace boundaries**: `Workspace` only carries an execution environment; applications choose which tools expose it. `LocalWorkspace` isolates nothing and is only for trusted workloads.
