...
- **`history_processors` is deprecated; use `capabilities=[ProcessHistory(p), ...]`**. The kwarg still works in 1.x but emits a `PydanticAIDeprecationWarning` and will be removed in v2.
