...
**Additional prefixes:** `litellm:`, `nebius:`, `ovhcloud:`, `alibaba:`, `sambanova:`, `vercel:`, `moonshotai:`, `inception:`. For truly custom providers, subclass `Model` or use `OpenAIChatModel` with a custom `base_url`.
