...
# TODO(v3): remove this module, along with the `fallback_model` parameters on `ImageGeneration` and
# `XSearch` (`__init__` and `from_spec`) and the deprecated property on each of them.
