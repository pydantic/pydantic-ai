...
ToolPolicyMode = Literal['error', 'model_retry']
"""Mode for handling tool usage limit violations."""
...
class ToolPolicy:
    ...
    """If `False`, reject ALL calls when batch exceeds limits. If `True` (default), allow partial execution."""
