    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            timeout: The default timeout for the xAI SDK client, in seconds, applied to all requests made
                through it. This is the only way to set a timeout on this provider: the SDK's `chat.create`
                takes no timeout, so `ModelSettings.timeout` has no effect here.
