...
class UploadedFile:
    ...
    Supported by:
    - `GoogleModel`: supports `video_metadata` for video files: https://ai.google.dev/gemini-api/docs/video-understanding, `vendor_metadata['media_processing']` is forwarded as the per-Part `media_processing` field: https://ai.google.dev/gemini-api/docs/video-understanding#agentic-video-understanding, and `UploadedFile.vendor_metadata['media_resolution']` is forwarded as the per-Part `media_resolution` field: https://ai.google.dev/gemini-api/docs/media-resolution
