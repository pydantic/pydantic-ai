...
AgentStreamEvent = Annotated[
    ModelResponseStreamEvent | HandleResponseEvent | CustomEvent, pydantic.Discriminator('event_kind')
]
"""An event in the agent stream: model response stream events, response-handling events, and custom events."""
