...
class ModelRequest:
    ...
    We use 'user' here even though not all parts of a `ModelRequest` are generated by a user.
    """
...
ModelMessagesTypeAdapter = pydantic.TypeAdapter(
    list[Annotated[ModelMessage, pydantic.Discriminator('role')]], config=pydantic.ConfigDict(defer_build=True)
)
