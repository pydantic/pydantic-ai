...
TOOL_CALL_ID_PREFIX: Final[str] = 'pyd_ai_'
"""Prefix used for tool call IDs auto-generated by pydantic-ai when the model does not provide one."""
...
def is_auto_generated_tool_call_id(tool_call_id: str) -> bool:
    """Whether a tool call ID was auto-generated by pydantic-ai rather than provided by the model."""
    return tool_call_id.startswith(TOOL_CALL_ID_PREFIX)
