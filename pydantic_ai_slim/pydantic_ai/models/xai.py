...
class XaiModel(Model):
    ...
    def _map_response_parts(self, parts: Sequence[ModelResponsePart]) -> chat_types.chat_pb2.Message | None:
        ...
        mcp_tool_call: chat_types.chat_pb2.ToolCall | None = None
    ...
    def _update_builtin_tool_status(
        ...
        mcp_tool_call: chat_types.chat_pb2.ToolCall | None,
    ) -> None:
        ...
        if status == 'failed' or 'error' in content:
            ...
            elif item.tool_name.startswith(MCPServerTool.kind) and mcp_tool_call is not None:
