...
class AnthropicModel(Model):
        ...
        for m in messages:
            if isinstance(m, ModelRequest):
                ...
                for response_part in m.parts:
                    ...
                    elif isinstance(response_part, CachePoint):
                        self._add_cache_control_to_last_param(assistant_content_params, ttl=response_part.ttl)
    ...
    def _add_cache_control_to_last_param(
        self, params: Sequence[BetaContentBlockParam], ttl: Literal['5m', '1h'] = '5m'
    ) -> None:
