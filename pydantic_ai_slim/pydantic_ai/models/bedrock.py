...
def _insert_cache_point_before_trailing_documents(
    ...
    *,
    ...
    skip_if_back_to_back: bool = False,
) -> bool:
    ...
    Args:
        ...
        skip_if_back_to_back: If True, skips insertion if there's already a cache point
    ...
    if trailing_start is not None and trailing_start > 0:
        # Check for back-to-back cache points if requested
        if skip_if_back_to_back:
