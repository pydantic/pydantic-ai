...
class _OpenRouterFunction(BaseModel):
    arguments: str | None
    """
...
class _OpenRouterChatCompletionMessageFunctionToolCall(BaseModel):
    id: str
    """The ID of the tool call."""

    function: _OpenRouterFunction
...
class _OpenRouterChatCompletionMessage(BaseModel):
    ...
    annotations: list[chat_completion_message.Annotation] | None = None
    """
    Annotations for the message, when applicable, as when using the
    [web search tool](https://platform.openai.com/docs/guides/tools-web-search?api-mode=chat).
    """

    audio: chat.ChatCompletionAudio | None = None
    """
    ...
    function_call: chat_completion_message.FunctionCall | None = None
    ...
    tool_calls: list[_OpenRouterChatCompletionMessageToolCallUnion] | None = None
    """The tool calls generated by the model, such as function calls."""


class _OpenRouterCompletionMessage(_OpenRouterChatCompletionMessage):
