...
KnownModelName = TypeAliasType(
    ...
    Literal[
        ...
        'synthorai:claude-haiku-4-5',
        'synthorai:claude-opus-5',
        'synthorai:claude-sonnet-5',
        'synthorai:deepseek-v4-flash',
        'synthorai:deepseek-v4-pro',
        'synthorai:gemini-3.5-flash',
        'synthorai:gemini-3.7-flash',
        'synthorai:glm-5.2',
        'synthorai:gpt-5.6-luna',
        'synthorai:gpt-5.6-sol',
        'synthorai:gpt-5.6-terra',
        'synthorai:kimi-k2.5',
        'synthorai:kimi-k3',
        'synthorai:minimax-m2.5',
        'synthorai:qwen3.8-max',
        'xai:grok-3',
        'xai:grok-3-fast',
