...
class TestStreamedResponse(StreamedResponse):
    ...
    async def _get_event_iterator(self) -> AsyncIterator[ModelResponseStreamEvent]:
        # Wrap with _stream_cancel_guard() to mirror real providers, which all
        # use this guard to suppress transport errors raised when the underlying
        # HTTP connection is closed by cancel().
