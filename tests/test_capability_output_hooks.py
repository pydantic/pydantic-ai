"""Tests for capability output hooks: `*_output_validate`, `*_output_process`, their error hooks, and retries.

Split out of `test_capabilities.py` to keep that file under the pre-commit large-file limit.
"""
...
from .capability_models import MyOutput, make_text_response
