"""Tests for Groq tool_choice setting."""
...
async def test_tool_choice_auto_live(allow_model_requests: None, groq_api_key: str):
...
async def test_tool_choice_required_live(allow_model_requests: None, groq_api_key: str):
...
async def test_tool_choice_none_live(allow_model_requests: None, groq_api_key: str):
...
async def test_tool_choice_specific_live(allow_model_requests: None, groq_api_key: str):
