        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_response_id='chatcmpl-d49afee6-9fba-4f85-aa6d-ab7ee987cf02',
                ...
                ModelResponse(
                    ...
                    provider_response_id='chatcmpl-d8bbdbbc-f570-44d1-923a-5368247cfbe8',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='chatcmpl-ce7d3bee-6144-44d7-932b-8a32f4a51fc3',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-ea816754-0fc3-4e83-ac30-3be5892c69de',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='chatcmpl-28c7a99e-25e4-41d1-ba7d-48fde7611a32',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-983f5456-cb27-4fb6-a4e3-ec2886b203e5',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
...
"""
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='chatcmpl-2ae48cf6-b199-43b0-b61b-bf9b9384583f',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
...
"""
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='chatcmpl-11b67e45-99c5-4c62-9560-4e7e6b83d467',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-f31b553f-6349-4657-aa8f-e36212dd1157',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-2a1f2f2c-8eff-407c-8675-678e7c58dcd6',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-543f274b-b668-40bf-99c0-af2c1c0e2f30',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-4ab8444c-1dd1-4412-a2de-3412ffc32ae7',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-686c3ec2-6aaa-4e7c-b44c-49dbc278acc8',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='chatcmpl-5d3fcec7-f117-43e8-a1b0-8054f34dc1d0',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='chatcmpl-6b0c7ad7-a9d8-4e4e-aa2e-6256ff5dfd50',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
...
"""
                    ...
                    provider_url='https://api.groq.com',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='chatcmpl-d3f915b6-4f47-4afa-a7df-10dfc121e670',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
