    ...
    assert result.all_messages() == snapshot(
        [
            ...
            ModelResponse(
                ...
                provider_details={
                    'finish_reason': 'tool_calls',
                    'timestamp': datetime(2025, 4, 29, 20, 21, 48, tzinfo=timezone.utc),
                },
            ...
            ModelResponse(
                ...
                provider_details={
                    'finish_reason': 'stop',
                    'timestamp': datetime(2025, 4, 29, 20, 21, 49, tzinfo=timezone.utc),
                },
...
"""
                ...
                provider_details={
                    'finish_reason': 'stop',
                    'timestamp': datetime(2025, 9, 9, 23, 7, 43, tzinfo=timezone.utc),
                },
