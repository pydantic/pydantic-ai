...
from ...conftest import IsDatetime, IsList, IsStr, try_import
...
def _match_google_tool_history(request: Any) -> Any:
    ...
    if isinstance(parsed_body, list):
        return request  # The matcher may be applied more than once.
