...
with try_import() as imports_successful:
    ...
    from pydantic_ai.providers.alibaba import AlibabaModelName
...
if not imports_successful():
    ...
    AlibabaModelName = AnthropicModelName = BedrockModelName = CohereModelName = GoogleModelName = None
