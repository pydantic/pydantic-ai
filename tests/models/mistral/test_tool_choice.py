        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_response_id='6818e057779a492f89af097d6f9acfd9',
                ...
                ModelResponse(
                    ...
                    provider_response_id='d6da359840834b05b4f6eaf6a095340d',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='988d2b5faff746c2b9ab5989ac6bdc80',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='151cbc95f74d407bb6601d3275936337',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='ac1e3a26b804474fb2982b3d4578a877',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='efed5ae7a3bd44d0a704d837d389bcce',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='0b59697c289446d3911550917a5d2d29',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='8a0c7091edc04c8f9f56e4bda5da6b81',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='6c78ffcb43b64c30b0df1e85ed9f5950',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='1ba014dcd4ad44959de0dbbf847756b6',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='1b0759426d354daf824c6e292846cde4',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='2848b30e5ab7405298e7a88f25c08229',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='69a9386fcfe34b1e9791d543bf0d1495',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='2bba8e3d4c2f4e7096ffd6c6e71de3c1',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='7f628f19a37b445ea8d79b30781f30b3',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
...
"""
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'stop'},
                    provider_response_id='61d14dd67e8e4df097aac22a3ff7fead',
                    finish_reason='stop',
                    run_id=IsStr(),
                ),
            ]
        ...
        assert result.all_messages() == snapshot(
            [
                ...
                ModelResponse(
                    ...
                    provider_url='https://api.mistral.ai',
                    provider_details={'finish_reason': 'tool_calls'},
                    provider_response_id='648f3fc0ba944749a3a518dcdb6688d9',
                    finish_reason='tool_call',
                    run_id=IsStr(),
                ),
                ModelRequest(
