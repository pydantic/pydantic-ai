...
async def test_groq_streamed_response_cancel():
    """Test that GroqStreamedResponse.cancel() closes the underlying stream."""

    from pydantic_ai.models import ModelRequestParameters
    from pydantic_ai.models.groq import GroqStreamedResponse
    ...
    response = GroqStreamedResponse(
        model_request_parameters=ModelRequestParameters(),
        _model_name='llama-3.3-70b-versatile',
        _model_profile=openai_model_profile('llama-3.3-70b-versatile'),
        _response=mock_stream,
        _provider_name='groq',
        _provider_url='https://api.groq.com',
...
async def test_groq_streamed_response_cancel_without_stream():
    """Test that GroqStreamedResponse.cancel() works when _stream_to_close is None."""
