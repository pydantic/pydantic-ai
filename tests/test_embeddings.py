...
class TestBedrock:
    ...
    async def test_arn_inference_profile_model_name(self, bedrock_provider: BedrockProvider):
        """Test that the model_name property returns the embedding model when ARN inference profile is used."""
