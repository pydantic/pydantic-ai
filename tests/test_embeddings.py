...
class TestSentenceTransformers:
    class FakeSentenceTransformer:
        ...
        def encode_query(self, sentences: str | Sequence[str], **kwargs: object) -> NDArray[np.float32]:
            return self._embeddings(sentences)

        def encode_document(self, sentences: str | Sequence[str], **kwargs: object) -> NDArray[np.float32]:
            return self._embeddings(sentences)
