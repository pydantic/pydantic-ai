...
# TestModel exposes the tool definitions without a provider request or VCR recording.
...
def test_tool_name_extracted_from_annotated_type():
    # Multiple output types make the underlying type name appear in the tool name.
