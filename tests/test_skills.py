...
def test_validate_skill_metadata_valid() -> None:
    ...
    warnings = validate_skill_metadata(frontmatter, 'Content here.')
...
def testvalidate_skill_metadata_name_too_long() -> None:
    ...
    warnings = validate_skill_metadata(frontmatter, 'Content')
...
def testvalidate_skill_metadata_instructions_too_long() -> None:
    ...
    warnings = validate_skill_metadata(frontmatter, instructions)
