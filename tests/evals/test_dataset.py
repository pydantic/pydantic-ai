            ...
            (
                'evaluator: {evaluator_name}',
                {
                    ...
                    'logfire.json_schema': {
                        ...
                        'properties': {
                            'evaluator_name': {},
                            'gen_ai.evaluation.evaluator_source': {},
                            'gen_ai.evaluation.result_count': {},
                            'gen_ai.evaluation.names': {'type': 'array'},
                        },
                    },
                    'gen_ai.evaluation.evaluator_source': {'name': 'SimpleEvaluator', 'arguments': None},
                    'gen_ai.evaluation.result_count': 2,
                    'gen_ai.evaluation.names': ['correct', 'confidence'],
                    'logfire.span_type': 'span',
                },
            ),
            (
