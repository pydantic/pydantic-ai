...
with try_import() as imports_successful:
    ...
    from pydantic_ai.providers.gateway import gateway_route, normalize_gateway_provider
...
def test_gateway_google_cloud_maps_to_legacy_gateway_wire_value() -> None:
    ...
    """
    assert gateway_route(normalize_gateway_provider('gateway/google-cloud')) == 'google-vertex'
    with pytest.warns(PydanticAIDeprecationWarning, match=r"'gateway/google-vertex.' prefix is deprecated"):
        assert gateway_route(normalize_gateway_provider('gateway/google-vertex')) == 'google-vertex'
