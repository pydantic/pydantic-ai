...
with try_import() as imports_successful:
    ...
    from pydantic_ai.providers.gateway import gateway_route, strip_gateway_prefix
...
def test_gateway_google_cloud_maps_to_legacy_gateway_wire_value() -> None:
    ...
    """
    assert gateway_route(strip_gateway_prefix('gateway/google-cloud')) == 'google-vertex'
    with pytest.warns(PydanticAIDeprecationWarning, match=r"'gateway/google-vertex.' prefix is deprecated"):
        assert gateway_route(strip_gateway_prefix('gateway/google-vertex')) == 'google-vertex'
