...
def test_anthropic_provider_model_profile_supports_tool_examples():
    profile = AnthropicProvider.model_profile('claude-opus-4-8')
    assert isinstance(profile, dict)
    assert profile.get('supports_tool_examples') is True
