...
from pydantic_ai.builtin_tools import SUPPORTED_BUILTIN_TOOLS, CodeExecutionTool
...
def test_bedrock_provider_model_profile(env: TestEnv, mocker: MockerFixture):
    ...
    assert anthropic_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset()
    ...
    assert mistral_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset()
    ...
    assert meta_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset()
    ...
    assert cohere_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset()
    ...
    assert deepseek_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset()
    ...
    assert amazon_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset()
    ...
    assert amazon_profile.get('bedrock_supports_tool_choice', False) is True
    assert amazon_profile.get('bedrock_supports_prompt_caching', False) is True
    assert amazon_profile.get('supported_builtin_tools', SUPPORTED_BUILTIN_TOOLS) == frozenset({CodeExecutionTool})
