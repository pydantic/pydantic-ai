...
from pydantic_ai.auth.openai_codex import OpenAICodexCredentials
...
def _credentials(*, revision: str = 'revision-1', fedramp: bool = False) -> OpenAICodexCredentials:
...
def test_provider_construction_is_lazy() -> None:
    ...
    assert provider.base_url == f'{OPENAI_CODEX_BASE_URL}/'
    assert source.calls == []
...
def test_provider_profile_declares_every_codex_backend_deviation() -> None:
    ...
    """
    profile = OpenAICodexProvider.model_profile('gpt-5.5')
