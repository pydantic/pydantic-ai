...
def test_handle_text_deltas_with_think_tags():
    ...
    event = manager.handle_text_delta(vendor_part_id='content', content='pre-', extract_think_tags=thinking_tags)
    assert event == snapshot(
    ...
    event = manager.handle_text_delta(vendor_part_id='content', content='thinking', extract_think_tags=thinking_tags)
    assert event == snapshot(
        PartDeltaEvent(
    ...
    event = manager.handle_text_delta(vendor_part_id='content', content='<think>', extract_think_tags=thinking_tags)
    assert event == snapshot(
    ...
    event = manager.handle_text_delta(vendor_part_id='content', content=' more', extract_think_tags=thinking_tags)
    assert event == snapshot(
        PartDeltaEvent(
    ...
    event = manager.handle_text_delta(vendor_part_id='content', content='post-', extract_think_tags=thinking_tags)
    assert event == snapshot(
