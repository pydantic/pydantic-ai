...
| Google | ✅ | Gemini 3 supports combining native tools with function tools and [`NativeOutput`][pydantic_ai.output.NativeOutput]. With earlier Gemini models, use [`PromptedOutput`][pydantic_ai.output.PromptedOutput] when combining native tools with function tools. |
