...
* `testing` - installs [Integration Testing with VCR](testing.md#integration-testing-with-vcr) dependencies `pyyaml` [PyPI ↗](https://pypi.org/project/pyyaml){:target="_blank"} and `brotli` [PyPI ↗](https://pypi.org/project/brotli){:target="_blank"}
