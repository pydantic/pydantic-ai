...
* `camb` - installs [Camb.ai Voice & Translation Tools](common-tools.md#cambai-voice-translation-tools) dependency `camb-sdk` [PyPI ↗](https://pypi.org/project/camb-sdk){:target="_blank"}
