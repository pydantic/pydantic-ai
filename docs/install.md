...
* `databricks` - installs [Databricks Model](models/databricks.md) dependencies `databricks-sdk` [PyPI ↗](https://pypi.org/project/databricks-sdk/){:target="_blank"} and `openai` [PyPI ↗](https://pypi.org/project/openai){:target="_blank"}
