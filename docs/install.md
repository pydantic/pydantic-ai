...
* `openai-codex` - installs the [OpenAI Codex subscription auth](models/openai-codex.md) dependencies `openai` [PyPI ↗](https://pypi.org/project/openai){:target="_blank"} and `filelock` [PyPI ↗](https://pypi.org/project/filelock){:target="_blank"}
