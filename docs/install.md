...
* `codex` - installs the [Codex subscription auth](models/codex.md) dependencies `openai` [PyPI ↗](https://pypi.org/project/openai){:target="_blank"} and `filelock` [PyPI ↗](https://pypi.org/project/filelock){:target="_blank"}
