...
* `cli` - installs [CLI](cli.md) dependencies `rich` [PyPI ↗](https://pypi.org/project/rich){:target="_blank"}, `prompt-toolkit` [PyPI ↗](https://pypi.org/project/prompt-toolkit){:target="_blank"}, `pyperclip` [PyPI ↗](https://pypi.org/project/pyperclip){:target="_blank"}, and `click` [PyPI ↗](https://pypi.org/project/click){:target="_blank"}
