---
description: "A Pydantic AI voice assistant example that streams your microphone to a realtime speech-to-speech model, calls tools mid-conversation, and supports barge-in."
---
