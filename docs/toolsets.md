...
You can also override the [`instructions()`][pydantic_ai.toolsets.AbstractToolset.instructions] method to provide instructions that will be injected into the agent's system prompt. This is useful for helping the model understand how to effectively use your toolset's tools.
