...
| [`ProviderCompaction`][pydantic_ai.capabilities.ProviderCompaction] | Message history [compaction](models/openai.md#message-compaction) — routes to provider-specific implementation | Yes |
