...
* [`prompt-shield-ai`](https://github.com/mthamil107/prompt-shield) - Apache 2.0 prompt-injection firewall with 33 input detectors and 9 output scanners. Ships [`scan_input()`](https://github.com/mthamil107/prompt-shield/blob/main/src/prompt_shield/integrations/pydantic_ai_guard.py) for pre-`agent.run()` gating and [`PromptShieldOutputValidator`](https://github.com/mthamil107/prompt-shield/blob/main/src/prompt_shield/integrations/pydantic_ai_guard.py) for the `result_validator` slot; `attach(agent)` installs both onto an existing `Agent`. Includes a [federated ed25519-signed threat-intel feed](https://github.com/mthamil107/prompt-shield-signatures), [compliance mappings](https://github.com/mthamil107/prompt-shield#compliance) for OWASP LLM Top 10, OWASP Agentic Top 10, and MITRE ATLAS, and [benchmark evaluation](https://github.com/mthamil107/prompt-shield#benchmark-results) on public datasets. Paper: [arXiv:2604.18248](https://arxiv.org/abs/2604.18248).
