...
You can return the Logprobs of the model in your response by setting `google_logprobs`and `google_top_logprobs`.
This feature is only supported for non-streaming requests and VertexAI.
