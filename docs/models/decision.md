...
- [`decision_tool_call_threshold`][pydantic_ai.models.decision.DecisionModelSettings.decision_tool_call_threshold], default 0.6, is how likely a function tool has to be, counting every function tool together, before the picked one is taken: [tools, pick then fill](#tools-pick-then-fill).
