...
xAI provides access to Grok models, developed by xAI.

## Install

To use xAI models, you need to either install `pydantic-ai`, or install `pydantic-ai-slim` with the `openai` optional group:
