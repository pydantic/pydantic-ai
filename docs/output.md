...
Every output type above can be streamed as the model produces it, with partial validation applied to each snapshot so you can render a structured result before it is complete. See [Streaming](streaming.md#streaming-output).
