...
!!! warning "Migrated to Pydantic Logfire"
    The AI Gateway has moved from `gateway.pydantic.dev` to [Pydantic Logfire](https://logfire.pydantic.dev/). If you were using the standalone gateway, see the [Pydantic Logfire documentation](https://logfire.pydantic.dev/docs/).
