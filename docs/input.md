...
|-------|-------------------|-------------------------|-------------|
| [`OpenAIChatModel`][pydantic_ai.models.openai.OpenAIChatModel] | `ImageUrl` | `AudioUrl`, `DocumentUrl`[^1] | `VideoUrl` |
...
[^1]: When using [`OpenRouterProvider`][pydantic_ai.providers.openrouter.OpenRouterProvider], `DocumentUrl` can be sent directly without downloading.
