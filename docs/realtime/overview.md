---
description: "Build voice agents with Pydantic AI realtime: hold live spoken conversations with speech-to-speech models from OpenAI, Google, xAI and Azure, with tools."
---
