...
There might be scenarios where you need the state diagram to flow in a direction different from 
the default top-to-bottom direction. You can specify one of the following directions to change this behavior:
...
The diagram generated by the above code is using 'Left-to-Right':
