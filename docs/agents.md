...
!!! note
    ...
    Note that the [`end_strategy`][pydantic_ai.agent.Agent.end_strategy] parameter only controls which tool calls in the *same* model response are executed, but does not change this fundamental limitation.
