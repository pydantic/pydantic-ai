...
[`CancellationToken`][pydantic_ai.CancellationToken] and [`RunContext.cancel_run()`][pydantic_ai.tools.RunContext.cancel_run] are same-process cancellation handles and cannot cross the Prefect durable boundary; cancel the Prefect flow instead.
