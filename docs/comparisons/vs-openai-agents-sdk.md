...
| Durable execution | Yes (Temporal) | Yes — [5+ integrations](../durable_execution/overview.md) |
...
| Coding harness | Yes (`SandboxAgent`) | Yes ([`Coder()`](https://pydantic.dev/docs/ai/harness/coder/)) |
...
| Guardrails | Yes (input, output, tool tripwires) | [Yes](https://pydantic.dev/docs/ai/harness/guardrails/) |
| Code sandboxes | Yes (hosted tools, sandbox clients) | [Yes](https://pydantic.dev/docs/ai/harness/#execution-environments) |
| Browser | Yes (`ComputerTool`, you host) | [Yes](https://pydantic.dev/docs/ai/harness/#web-research) |
| Memory | Yes (sessions) | [Yes](https://pydantic.dev/docs/ai/harness/memory/) |
