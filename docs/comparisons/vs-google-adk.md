...
| Coding harness | `AntigravityAgent` (experimental) | Yes ([`Coder()`](https://pydantic.dev/docs/ai/harness/coder/)) |
| Graph library | `SequentialAgent`, `LoopAgent`, `ParallelAgent` | Yes ([`pydantic-graph`](../graph.md)) |
| Multi-agent | `LoopAgent`, `ParallelAgent` | [Sub-agents](../multi-agent-applications.md), [hand-offs](../multi-agent-applications.md#programmatic-agent-hand-off), or [graph](../graph.md) |
