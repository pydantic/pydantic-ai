...
| Durable execution | Yes (session tree on disk) | Yes — [5+ integrations](../durable_execution/overview.md) |
...
| Coding harness | Yes — it is the product | Yes ([`Coder()`](https://pydantic.dev/docs/ai/harness/coder/)) |
