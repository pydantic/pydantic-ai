...
|---|---|---|
| An agent is | A `CompiledStateGraph` | A typed coroutine |
...
the same agent. Their sandbox is hosted; ours is a Modal account you bring.
...
*langchain 1.4.0 / langgraph 1.2.11 / deepagents 0.7.13, Pydantic AI 2.42. Interrupt traces re-run
2026-09-11. `abort()` is on `@beta` `GraphRunStream`. [Tell us](https://github.com/pydantic/pydantic-ai/issues/new) if a pin goes stale.*
