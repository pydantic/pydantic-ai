...
| Google (Gemini 3+) | `include_thoughts=True` | `thinking_level='HIGH'` | Models whose documented levels start at `low` (e.g. `gemini-3.7-flash`) map unified `'minimal'` and `thinking=False` to `thinking_level='LOW'` |
