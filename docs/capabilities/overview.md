...
|---|---|---|
| [Local Workspace](../workspace.md) | Core | Give tools a [workspace](../workspace.md) on this machine through `ctx.workspace`: host subprocesses and files, with no isolation |
