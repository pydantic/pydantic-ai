...
Pydantic AI shows the retrieval pattern in the [RAG example](../examples/rag.md), where a search tool is registered against a vector database. These packages provide it as a capability, bundling retrieval tools with citation handling and instructions:
