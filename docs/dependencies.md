...
PydanticAI uses a dependency injection system to provide data and services to your agent's [system prompts](agents.md#system-prompts), [tools](tools.md#function-tools) and [result validators](results.md#result-validators-functions).
...
[System prompt functions](agents.md#system-prompts), [function tools](tools.md#function-tools) and [result validators](results.md#result-validators-functions) are all run in the async context of an agent run.
...
As well as system prompts, dependencies can be used in [tools](tools.md#function-tools) and [result validators](results.md#result-validators-functions).
