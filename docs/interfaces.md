...
| **GitHub** | Run an agent as a step in a workflow, or on issues, pull requests and a schedule, writing back through safe outputs; the one surface with nobody at the other end | [GitHub Actions](github-actions.md) |
