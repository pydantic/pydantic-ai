...
12. **Realtime Voice**:
Build [speech-to-speech agents](api/realtime.md) on native realtime models over a persistent bidirectional audio connection, with the same tools, capabilities, and observability as any other agent.
