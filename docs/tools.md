...
Here's an example where we use [`TestModel.last_model_request_params`][pydantic_ai.models.test.TestModel.last_model_request_params] to inspect the tool schema that would be passed to the model.
...
print(test_model.last_model_request_params.function_tools)
"""
[
    ToolDefinition(
        name='foobar',
