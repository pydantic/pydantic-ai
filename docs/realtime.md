...
PCM16 input at **16 kHz** for Gemini and **24 kHz** for OpenAI, Azure OpenAI, and xAI; all four
...
to realtime sessions. OpenAI, Azure OpenAI, and xAI realtime sessions do not expose
...
Azure OpenAI, and xAI — see [`supports_manual_turn_control`](#model-profile)); Gemini Live has no manual turn verbs, so
...
::: pydantic_ai.realtime.azure.AzureRealtimeModel
