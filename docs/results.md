...
1. [`stream_structured`][pydantic_ai.result.StreamedRunResult.stream_structured] streams the data as [`ModelMessage`][pydantic_ai.messages.ModelMessage] objects, thus iteration can't fail with a `ValidationError`.
