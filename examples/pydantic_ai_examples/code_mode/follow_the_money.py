...
_ACCOUNTS: dict[str, dict[str, Any]] = {
    'ACC-001': {
        'id': 'ACC-001', 'name': 'Viktor Petrov', 'type': 'individual', 'status': 'flagged',
        'date_of_birth': '1978-06-14', 'nationality': 'Russian Federation',
        'address': '42 Nevsky Prospect, Apt 15, St. Petersburg, Russia 191025',
        'phone': '+7-812-555-0147', 'email': 'v.petrov@petrovconsulting.com',
        'occupation': 'Import/Export Consultant', 'employer': 'Self-employed',
        'annual_income': '$180,000-$250,000', 'tax_id': 'XX-XXX7823',
        'risk_score': 78, 'kyc_status': 'review_pending', 'last_review_date': '2024-01-05',
        'account_opened': '2020-03-15', 'account_balance': 12450.00,
    },
    'ACC-002': {
        'id': 'ACC-002', 'name': 'Oceanic Trading LLC', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2018-33847', 'jurisdiction': 'Delaware',
        'incorporation_date': '2018-07-22', 'registered_agent': 'National Corporate Services',
        'address': '1200 Harbor Blvd, Suite 400, Wilmington, DE 19801',
        'phone': '+1-302-555-0182', 'email': 'accounts@oceanictrading.com',
        'industry': 'International Trade', 'annual_revenue_band': '$5M-$10M',
        'employee_count': 28, 'primary_contact': 'Elena Vasquez, CFO',
        'tax_id': 'XX-XXX4190', 'risk_score': 45, 'kyc_status': 'current',
        'last_review_date': '2023-09-18', 'account_opened': '2018-08-01', 'account_balance': 234780.50,
    },
    'ACC-003': {
        'id': 'ACC-003', 'name': 'Baltic Shipping Co', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2017-28934', 'jurisdiction': 'New York',
        'incorporation_date': '2017-03-10', 'registered_agent': 'Harbor Legal Services',
        'address': '45 Water Street, 12th Floor, New York, NY 10004',
        'phone': '+1-212-555-0293', 'email': 'finance@balticshipping.com',
        'industry': 'Maritime Logistics', 'annual_revenue_band': '$10M-$25M',
        'employee_count': 65, 'primary_contact': 'Andrei Volkov, Director of Operations',
        'tax_id': 'XX-XXX8821', 'risk_score': 38, 'kyc_status': 'current',
        'last_review_date': '2023-11-02', 'account_opened': '2017-04-15', 'account_balance': 567200.00,
    },
    'ACC-004': {
        'id': 'ACC-004', 'name': 'Maria Santos', 'type': 'individual', 'status': 'active',
        'date_of_birth': '1985-11-28', 'nationality': 'Brazilian',
        'address': '789 Brickell Ave, Apt 2201, Miami, FL 33131',
        'phone': '+1-305-555-0174', 'email': 'maria.santos@gmail.com',
        'occupation': 'Real Estate Agent', 'employer': 'Luxe Properties International',
        'annual_income': '$95,000-$150,000', 'tax_id': 'XX-XXX5567',
        'risk_score': 32, 'kyc_status': 'current', 'last_review_date': '2023-12-15',
        'account_opened': '2021-06-20', 'account_balance': 45890.25,
    },
    'ACC-005': {
        'id': 'ACC-005', 'name': 'Sunrise Consulting', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2019-41205', 'jurisdiction': 'Nevada',
        'incorporation_date': '2019-01-08', 'registered_agent': 'Silver State Filings',
        'address': '3960 Howard Hughes Pkwy, Suite 500, Las Vegas, NV 89169',
        'phone': '+1-702-555-0138', 'email': 'billing@sunriseconsulting.net',
        'industry': 'Management Consulting', 'annual_revenue_band': '$1M-$5M',
        'employee_count': 8, 'primary_contact': 'David Park, Managing Partner',
        'tax_id': 'XX-XXX9034', 'risk_score': 51, 'kyc_status': 'current',
        'last_review_date': '2023-10-30', 'account_opened': '2019-02-14', 'account_balance': 189340.00,
    },
    'ACC-006': {
        'id': 'ACC-006', 'name': 'Digital Media Partners', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2020-55672', 'jurisdiction': 'California',
        'incorporation_date': '2020-05-14', 'registered_agent': 'Pacific Registered Agents',
        'address': '2049 Century Park East, Suite 2500, Los Angeles, CA 90067',
        'phone': '+1-310-555-0216', 'email': 'ap@digitalmediapartners.co',
        'industry': 'Digital Marketing', 'annual_revenue_band': '$1M-$5M',
        'employee_count': 15, 'primary_contact': 'Sarah Kim, Head of Finance',
        'tax_id': 'XX-XXX2288', 'risk_score': 41, 'kyc_status': 'current',
        'last_review_date': '2023-08-22', 'account_opened': '2020-06-01', 'account_balance': 112450.75,
    },
    'ACC-007': {
        'id': 'ACC-007', 'name': 'Northern Logistics', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2016-19483', 'jurisdiction': 'Illinois',
        'incorporation_date': '2016-09-30', 'registered_agent': 'Midwest Corporate Services',
        'address': '233 S Wacker Drive, Suite 8400, Chicago, IL 60606',
        'phone': '+1-312-555-0187', 'email': 'invoices@northernlogistics.com',
        'industry': 'Freight & Logistics', 'annual_revenue_band': '$5M-$10M',
        'employee_count': 42, 'primary_contact': 'Michael Torres, VP Finance',
        'tax_id': 'XX-XXX6145', 'risk_score': 29, 'kyc_status': 'current',
        'last_review_date': '2023-07-14', 'account_opened': '2016-10-15', 'account_balance': 423100.00,
    },
    'ACC-008': {
        'id': 'ACC-008', 'name': 'Quick Cash Services', 'type': 'business', 'status': 'active',
        'registration_number': 'MSB-2019-08841', 'jurisdiction': 'Florida',
        'incorporation_date': '2019-11-05', 'registered_agent': 'Sunshine State Filings',
        'address': '100 SE 2nd Street, Suite 3200, Miami, FL 33131',
        'phone': '+1-786-555-0144', 'email': 'compliance@quickcashsvc.com',
        'industry': 'Money Services Business', 'annual_revenue_band': '$1M-$5M',
        'employee_count': 11, 'primary_contact': 'Roberto Diaz, Compliance Officer',
        'tax_id': 'XX-XXX7790', 'risk_score': 67, 'kyc_status': 'current',
        'last_review_date': '2024-01-02', 'account_opened': '2019-12-01', 'account_balance': 78920.50,
    },
    'ACC-009': {
        'id': 'ACC-009', 'name': 'Golden Gate Holdings', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2019-45892', 'jurisdiction': 'Delaware',
        'incorporation_date': '2019-03-15', 'registered_agent': 'National Corporate Services',
        'address': '1455 Market Street, Suite 600, San Francisco, CA 94103',
        'phone': '+1-415-555-0189', 'email': 'ir@goldengateholdings.com',
        'industry': 'Investment Management', 'annual_revenue_band': '$1M-$5M',
        'employee_count': 12, 'primary_contact': 'James Chen, Managing Director',
        'tax_id': 'XX-XXX4521', 'risk_score': 62, 'kyc_status': 'current',
        'last_review_date': '2023-11-20', 'account_opened': '2019-04-01', 'account_balance': 1245000.00,
    },
    'ACC-010': {
        'id': 'ACC-010', 'name': 'Harbor Real Estate', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2020-62341', 'jurisdiction': 'California',
        'incorporation_date': '2020-02-28', 'registered_agent': 'Pacific Registered Agents',
        'address': '101 California Street, Suite 3800, San Francisco, CA 94111',
        'phone': '+1-415-555-0231', 'email': 'closings@harborrealestate.com',
        'industry': 'Real Estate', 'annual_revenue_band': '$5M-$10M',
        'employee_count': 22, 'primary_contact': 'Linda Wu, Broker',
        'tax_id': 'XX-XXX3392', 'risk_score': 25, 'kyc_status': 'current',
        'last_review_date': '2023-06-10', 'account_opened': '2020-03-15', 'account_balance': 892000.00,
    },
    'ACC-011': {
        'id': 'ACC-011', 'name': 'Cafe Milano', 'type': 'business', 'status': 'active',
        'registration_number': 'DBA-2021-08823', 'jurisdiction': 'California',
        'incorporation_date': '2021-04-12', 'registered_agent': 'Self',
        'address': '2154 Union Street, San Francisco, CA 94123',
        'phone': '+1-415-555-0198', 'email': 'owner@cafemilano-sf.com',
        'industry': 'Food & Beverage', 'annual_revenue_band': '$500K-$1M',
        'employee_count': 9, 'primary_contact': 'Giuseppe Rossi, Owner',
        'tax_id': 'XX-XXX1147', 'risk_score': 15, 'kyc_status': 'current',
        'last_review_date': '2023-05-20', 'account_opened': '2021-05-01', 'account_balance': 34500.00,
    },
    'ACC-012': {
        'id': 'ACC-012', 'name': 'Island Getaway Travel', 'type': 'business', 'status': 'active',
        'registration_number': 'LLC-2020-71456', 'jurisdiction': 'Florida',
        'incorporation_date': '2020-08-19', 'registered_agent': 'Sunshine State Filings',
        'address': '800 Brickell Ave, Suite 1100, Miami, FL 33131',
        'phone': '+1-305-555-0156', 'email': 'bookings@islandgetaway.travel',
        'industry': 'Travel & Tourism', 'annual_revenue_band': '$1M-$5M',
        'employee_count': 14, 'primary_contact': 'Carmen Reyes, General Manager',
        'tax_id': 'XX-XXX8834', 'risk_score': 20, 'kyc_status': 'current',
        'last_review_date': '2023-09-05', 'account_opened': '2020-09-01', 'account_balance': 67800.00,
    },
    'ACC-013': {
        'id': 'ACC-013', 'name': 'City Newsstand', 'type': 'business', 'status': 'active',
        'registration_number': 'DBA-2015-04412', 'jurisdiction': 'New York',
        'incorporation_date': '2015-06-01', 'registered_agent': 'Self',
        'address': '350 Fifth Avenue, Lobby Level, New York, NY 10118',
        'phone': '+1-212-555-0133', 'email': 'citynewsstand@aol.com',
        'industry': 'Retail', 'annual_revenue_band': '$100K-$500K',
        'employee_count': 3, 'primary_contact': 'Frank Abagnale Jr, Owner',
        'tax_id': 'XX-XXX2201', 'risk_score': 10, 'kyc_status': 'current',
        'last_review_date': '2022-12-01', 'account_opened': '2015-07-01', 'account_balance': 8900.00,
    },
    'ACC-014': {
        'id': 'ACC-014', 'name': 'Metro Dry Cleaning', 'type': 'business', 'status': 'active',
        'registration_number': 'DBA-2018-12290', 'jurisdiction': 'New York',
        'incorporation_date': '2018-03-22', 'registered_agent': 'Self',
        'address': '891 Lexington Ave, New York, NY 10065',
        'phone': '+1-212-555-0177', 'email': 'metrodrycleaning@gmail.com',
        'industry': 'Laundry Services', 'annual_revenue_band': '$100K-$500K',
        'employee_count': 5, 'primary_contact': 'Tony Park, Owner',
        'tax_id': 'XX-XXX6678', 'risk_score': 12, 'kyc_status': 'current',
        'last_review_date': '2023-02-15', 'account_opened': '2018-04-01', 'account_balance': 15200.00,
    },
    'ACC-015': {
        'id': 'ACC-015', 'name': 'Pine Street Deli', 'type': 'business', 'status': 'active',
        'registration_number': 'DBA-2019-09917', 'jurisdiction': 'Illinois',
        'incorporation_date': '2019-07-14', 'registered_agent': 'Self',
        'address': '47 W Pine Street, Chicago, IL 60610',
        'phone': '+1-312-555-0129', 'email': 'pinestreetdeli@outlook.com',
        'industry': 'Food & Beverage', 'annual_revenue_band': '$100K-$500K',
        'employee_count': 4, 'primary_contact': 'Sam Goldstein, Owner',
        'tax_id': 'XX-XXX3345', 'risk_score': 8, 'kyc_status': 'current',
        'last_review_date': '2023-04-10', 'account_opened': '2019-08-01', 'account_balance': 11300.00,
    },
}
...
_COMPACT_TXNS: list[tuple[str, str, str, float, str, str, str, str]] = [
    ...
    ('TXN-001', 'ACC-001', 'ACC-002', 43580.00, 'EUR', '2024-01-15', 'Consulting services - Q1 retainer', 'wire'),
    ('TXN-002', 'ACC-001', 'ACC-003', 25050.00, 'GBP', '2024-01-16', 'Shipping contract - Baltic route', 'wire'),
    ('TXN-003', 'ACC-001', 'ACC-004', 23150.00, 'USD', '2024-01-17', 'Personal transfer - living expenses', 'wire'),
    # --- Layer 0: ACC-001 small outgoing (noise, all below threshold) ---
    ('TXN-034', 'ACC-001', 'ACC-011', 1200.00, 'USD', '2024-01-15', 'Catering deposit - private event', 'ach'),
    ('TXN-035', 'ACC-001', 'ACC-013', 850.00, 'USD', '2024-01-16', 'Newspaper subscription - annual', 'ach'),
    ('TXN-036', 'ACC-001', 'ACC-014', 2100.00, 'USD', '2024-01-18', 'Suit dry cleaning - monthly', 'ach'),
    ('TXN-037', 'ACC-001', 'ACC-015', 400.00, 'USD', '2024-01-19', 'Lunch - client meeting', 'ach'),
    # --- Layer 1: ACC-002 outgoing ---
    # TXN-004 is a BATCH wire — real recipients hidden behind BATCH-001
    ('TXN-004', 'ACC-002', 'BATCH', 28400.00, 'USD', '2024-01-19', 'Batch wire - multiple payees', 'batch_wire'),
    ('TXN-005', 'ACC-002', 'ACC-006', 14570.00, 'EUR', '2024-01-20', 'Marketing campaign - Q1 digital', 'wire'),
    ('TXN-006', 'ACC-002', 'ACC-013', 2100.00, 'USD', '2024-01-19', 'Office supplies and newspapers', 'ach'),
    ('TXN-038', 'ACC-002', 'ACC-014', 3200.00, 'USD', '2024-01-20', 'Uniform cleaning - warehouse staff', 'ach'),
    # --- Layer 1: ACC-003 outgoing ---
    ('TXN-007', 'ACC-003', 'ACC-005', 18500.00, 'USD', '2024-01-20', 'Freight forwarding - container lot', 'wire'),
    ('TXN-008', 'ACC-003', 'ACC-007', 9825.00, 'GBP', '2024-01-21', 'Warehouse rental - Q1 lease', 'wire'),
    ('TXN-009', 'ACC-003', 'ACC-014', 1950.00, 'USD', '2024-01-20', 'Uniform cleaning service', 'ach'),
    ('TXN-039', 'ACC-003', 'ACC-015', 800.00, 'USD', '2024-01-21', 'Staff lunch order', 'ach'),
    # --- Layer 1: ACC-004 outgoing ---
    # TXN-010 is a BATCH wire — real recipients hidden behind BATCH-002
    ('TXN-010', 'ACC-004', 'BATCH', 13600.00, 'USD', '2024-01-22', 'Batch wire - media + investment', 'batch_wire'),
    ('TXN-011', 'ACC-004', 'ACC-008', 9750.00, 'USD', '2024-01-21', 'Currency exchange - BRL to USD', 'wire'),
    ('TXN-040', 'ACC-004', 'ACC-011', 1200.00, 'USD', '2024-01-22', 'Event catering deposit', 'ach'),
    ('TXN-041', 'ACC-004', 'ACC-012', 3400.00, 'USD', '2024-01-23', 'Travel booking - Cancun package', 'ach'),
    # --- Layer 2: ACC-005 outgoing ---
    ('TXN-012', 'ACC-005', 'ACC-009', 38495.00, 'EUR', '2024-01-24', 'Investment deposit - Q1 2024 tranche', 'wire'),
    ('TXN-013', 'ACC-005', 'ACC-010', 6200.00, 'USD', '2024-01-25', 'Property deposit - Unit 4B', 'wire'),
    ('TXN-042', 'ACC-005', 'ACC-015', 900.00, 'USD', '2024-01-24', 'Staff lunch catering', 'ach'),
    # --- Layer 2: ACC-006 outgoing ---
    ('TXN-014', 'ACC-006', 'ACC-009', 22300.00, 'USD', '2024-01-25', 'Equity purchase - Series B', 'wire'),
    ('TXN-015', 'ACC-006', 'ACC-011', 2800.00, 'EUR', '2024-01-26', 'Catering contract - annual retainer', 'ach'),
    # --- Layer 2: ACC-007 outgoing ---
    ('TXN-016', 'ACC-007', 'ACC-009', 10250.00, 'USD', '2024-01-26', 'Fleet financing - vehicle lease', 'wire'),
    ('TXN-017', 'ACC-007', 'ACC-015', 1800.00, 'USD', '2024-01-25', 'Lunch catering - staff event', 'ach'),
    # --- Layer 2: ACC-008 outgoing ---
    ('TXN-018', 'ACC-008', 'ACC-009', 7150.00, 'CHF', '2024-01-27', 'Wire transfer - client remittance', 'wire'),
    ('TXN-019', 'ACC-008', 'ACC-012', 1500.00, 'USD', '2024-01-26', 'Travel booking - Caribbean package', 'ach'),
    # --- Noise: incoming from external accounts ---
    ('TXN-020', 'EXT-101', 'ACC-002', 85000.00, 'USD', '2024-01-10', 'Import duties settlement - FY2023', 'wire'),
    ('TXN-021', 'EXT-102', 'ACC-003', 62400.00, 'EUR', '2024-01-08', 'Charter party payment - MV Nordic Star', 'wire'),
    ('TXN-022', 'EXT-103', 'ACC-005', 34750.00, 'USD', '2024-01-12', 'Strategy engagement - Phase 2 milestone', 'wire'),
    ('TXN-023', 'EXT-104', 'ACC-006', 19200.00, 'USD', '2024-01-11', 'Ad campaign management - Nov/Dec', 'ach'),
    ('TXN-024', 'EXT-105', 'ACC-007', 27800.00, 'USD', '2024-01-09', 'Warehousing contract - quarterly', 'wire'),
    ('TXN-025', 'EXT-106', 'ACC-008', 15600.00, 'CHF', '2024-01-13', 'FX settlement - batch 2024-01', 'wire'),
    ('TXN-026', 'EXT-107', 'ACC-009', 120000.00, 'USD', '2024-01-05', 'Capital call - Fund III', 'wire'),
    ('TXN-027', 'EXT-108', 'ACC-004', 41300.00, 'USD', '2024-01-14', 'Trust distribution - Q4 2023', 'wire'),
    ('TXN-028', 'EXT-109', 'ACC-001', 155000.00, 'EUR', '2024-01-03', 'Trade consortium dividend', 'wire'),
    ('TXN-029', 'EXT-110', 'ACC-005', 22000.00, 'USD', '2024-01-07', 'Advisory retainer - Jan 2024', 'ach'),
    ('TXN-030', 'EXT-111', 'ACC-009', 55000.00, 'USD', '2024-01-06', 'LP commitment - tranche 2', 'wire'),
    ('TXN-031', 'EXT-112', 'ACC-009', 38500.00, 'USD', '2024-01-11', 'Co-investment - Project Evergreen', 'wire'),
    ('TXN-032', 'EXT-113', 'ACC-006', 11750.00, 'USD', '2024-01-09', 'Creative services - website redesign', 'ach'),
    ('TXN-033', 'EXT-114', 'ACC-002', 29300.00, 'GBP', '2024-01-12', 'Commodity futures settlement', 'wire'),
    # --- More noise from externals (to fill pages) ---
    ('TXN-043', 'EXT-115', 'ACC-001', 8500.00, 'USD', '2024-01-04', 'Energy consulting retainer', 'wire'),
    ('TXN-044', 'EXT-116', 'ACC-001', 12000.00, 'EUR', '2024-01-06', 'Textile import commission', 'wire'),
    ('TXN-045', 'EXT-117', 'ACC-001', 3200.00, 'EUR', '2024-01-09', 'Freight brokerage fee', 'ach'),
    ('TXN-046', 'EXT-118', 'ACC-002', 45000.00, 'USD', '2024-01-07', 'Coral Bay export contract - Phase 1', 'wire'),
    ('TXN-047', 'EXT-119', 'ACC-002', 18700.00, 'USD', '2024-01-14', 'Advisory fee - M&A due diligence', 'wire'),
    ('TXN-048', 'EXT-120', 'ACC-003', 22500.00, 'EUR', '2024-01-05', 'Mineral transport contract', 'wire'),
    ('TXN-049', 'EXT-121', 'ACC-003', 9800.00, 'GBP', '2024-01-11', 'Cargo handling services - Q4', 'wire'),
    ('TXN-050', 'EXT-122', 'ACC-005', 15600.00, 'USD', '2024-01-09', 'Strategy workshop facilitation', 'wire'),
    ('TXN-051', 'EXT-123', 'ACC-005', 7200.00, 'USD', '2024-01-13', 'Holding company admin fee', 'ach'),
    ('TXN-052', 'EXT-115', 'ACC-009', 28000.00, 'USD', '2024-01-08', 'Energy sector investment', 'wire'),
    ('TXN-053', 'EXT-119', 'ACC-009', 19500.00, 'USD', '2024-01-13', 'Advisory placement fee', 'wire'),
]
...
def _build_transaction(
    idx: int, txn_id: str, from_acc: str, to_acc: str,
    amount: float, currency: str, date: str, memo: str, txn_type: str,
) -> dict[str, Any]:
    """Expand compact transaction tuple into a verbose API-style record."""
    day = int(date.split('-')[2])
    settlement_day = min(day + 2, 28)
    prefix = {'wire': 'WR', 'ach': 'ACH', 'check': 'CHK', 'internal': 'INT', 'batch_wire': 'BW'}
...
def _compute_ground_truth() -> list[tuple[str, str, int, float]]:
    ...
    def _record_edge(from_acct: str, to_acct: str, amount: float, currency: str) -> list[str]:
            ...
            for txn in _TRANSACTIONS.values():
                ...
                if txn['type'] == 'batch_wire':
                    ...
                    for sub in batch['sub_transactions']:
                        dests = _record_edge(acct, sub['to_account'], sub['amount'], sub['currency'])
                        for d in dests:
                            if d not in visited:
                                next_layer.append(d)
                else:
                    dests = _record_edge(acct, txn['to_account'], txn['amount'], txn['currency'])
                    for d in dests:
                        if d not in visited:
                            next_layer.append(d)
