...
Several agents can share this file. Each entry belongs to the **lane** that wrote it. Read your own lane's latest entry via `latest-handoff.sh`; never pick one by eye.
